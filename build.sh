...
xcodebuild -configuration 'MinSizeRel' -sdk 'iphoneos9.2' clean build ARCHS="armv7" ONLY_ACTIVE_ARCH=NO CONFIGURATION_BUILD_DIR=$IOS_OUTDIR
mv $IOS_OUTDIR/* $GLOBAL_OUTDIR/armv7/

xcodebuild -configuration 'MinSizeRel' -sdk 'iphoneos9.2' clean build ARCHS="arm64" ONLY_ACTIVE_ARCH=NO CONFIGURATION_BUILD_DIR=$IOS_OUTDIR
mv $IOS_OUTDIR/* $GLOBAL_OUTDIR/arm64/

xcodebuild -configuration 'MinSizeRel' -sdk 'iphonesimulator9.2' clean build ARCHS="x86_64" ONLY_ACTIVE_ARCH=NO CONFIGURATION_BUILD_DIR=$SIM_OUTDIR
